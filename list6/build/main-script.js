...
const q3_banco_1 = __importDefault(require("./q3-banco"));
const q4_conta_1 = __importDefault(require("./q4-conta"));
function main() {
    let meliuz = new q3_banco_1.default();
    let conta1 = new q4_conta_1.default("001", 101);
    let conta2 = new q4_conta_1.default("002", 100);
